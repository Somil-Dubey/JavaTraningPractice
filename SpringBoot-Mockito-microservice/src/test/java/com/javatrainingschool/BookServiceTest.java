...
/*import com.javatrainingschool.SpringBootMockitoMicroserviceApplication;
...
@SpringBootTest(classes = SpringBootMockitoMicroserviceApplication.class)
public class BookServiceTest {
	...
	public void testGetAllBooks() {
		...
		Assertions.assertTrue(result.get(0).getAuthor().endsWith("-Dubey"));
		Assertions.assertEquals("Abc-Dubey", result.get(0).getAuthor());
	}
}
 ...
 * 
 * import com.javatrainingschool.SpringBootMockitoMicroserviceApplication;
 * import com.javatrainingschool.entity.Book; import
 * com.javatrainingschool.repository.BookRepository; import
 * com.javatrainingschool.service.BookService;
 * 
 * @SpringBootTest(classes=SpringBootMockitoMicroserviceApplication.class)
 * public class BookServiceTest {
 * 
 ...
 * 
 * List<Book> books = new ArrayList<>(); Book b = new Book(1, "Learn Java",
 * "Abc", 100, "borrowed"); books.add(b);
 * 
 * when(bookRepo.findAll()).thenReturn(books); List<Book> result =
